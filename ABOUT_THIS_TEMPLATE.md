...
├── standardized_project_template             # The main python package for the project
...
e.g: `cat standardized_project_template/VERSION` will get the project version without harming
